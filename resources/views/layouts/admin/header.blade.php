<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="#" class="site_title"><i class="fa fa-cart-plus"></i> <span>E-Commerce</span></a>
        </div>
        ...
        <div class="profile clearfix">
            ...
            <div class="profile_info">
                <span>Welcome,</span>
                <h2>{{ auth('web')->user()->user_name ? auth('web')->user()->user_name : "Admin" }}</h2>
            </div>
        </div>
        <!-- /menu profile quick info -->
        <br />
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img style="border:1px solid #b7b7b7;" src="{{ asset('img/img.jpg') }}" alt="">{{ auth('web')->user()->user_name ? auth('web')->user()->user_name : "Admin" }}
